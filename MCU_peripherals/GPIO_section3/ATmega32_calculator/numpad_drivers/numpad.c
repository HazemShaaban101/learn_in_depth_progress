...
void NUMPAD_init(void)
{
	...
	GPIO_Pin_Init(NUMPAD_PORT, 2, GPIO_MODE_OUT_PP);
	GPIO_Pin_Init(NUMPAD_PORT, 3, GPIO_MODE_OUT_PP);
	
	GPIO_Pin_Init(NUMPAD_PORT, 4, GPIO_MODE_IN_FLOATING);
	GPIO_Pin_Init(NUMPAD_PORT, 5, GPIO_MODE_IN_FLOATING);
	GPIO_Pin_Init(NUMPAD_PORT, 6, GPIO_MODE_IN_FLOATING);
	GPIO_Pin_Init(NUMPAD_PORT, 7, GPIO_MODE_IN_FLOATING);
	// output pins high, input pins pulled high
	// NUMPAD_WRITE = 0xFF;
	GPIO_Pin_Write(NUMPAD_PORT, 0, GPIO_HIGH);
	GPIO_Pin_Write(NUMPAD_PORT, 1, GPIO_HIGH);
	GPIO_Pin_Write(NUMPAD_PORT, 2, GPIO_HIGH);
